...
def add_dims(fig, apex_x, apex_y, directions, lengths, angles):
    ...
    for i in range(len(lengths)):
        ...
        # SAĞ EL KURALI: Vektörün sağına dik (y, -x)
...
with st.sidebar:
    ...
    # HATA FIX: Parametreler kesinlikle float listesi olarak gönderiliyor.
